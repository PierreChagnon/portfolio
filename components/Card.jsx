    ...
    return (
        ...
        >
            ...
            <div className="flex w-full justify-center items-center text-lg my-4">
                ...
                <a href={githubLink} onclick="event.preventDefault()" target="_blank" className='ml-4 hover:text-teal-800 transition duration-150 ease-out hover:ease-in py-4 text-teal-600'>Github link</a>
            </div>
